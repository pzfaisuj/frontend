...
<div id="page">
    ...
    <div class="row justify-content-md-center">
        <div class="col-md-12 col-lg-6 col-xl-4">
            ...
            <div id="login-panel" class="card customCard mb-5">
                <div class="card-body">
                    ...
                    <hr>
                    <p class="text-center">Nie masz jeszcze swojego konta?<a href="/frontend/register.php" class="px-2"><br>Załóż nowe konto!</a></p>
                </div>
            </div>
        </div> 
    </div>
